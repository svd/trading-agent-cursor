...
> **Примечание:** Это правило было конвертировано в skill `homework`. Для активации используйте skill `@homework`. Это правило оставлено для справки.
...
**Вход**: 185.52 (максимально близко к уровню 185.50 - принцип близости, см. @levels)
