...
│   └── skills/         # Skills для автоматического применения
│       └── screening/   # Skill для скрининга инструментов
...
Skills - это автоматически применяемые инструкции для выполнения специфических задач. Агент автоматически использует skills при обнаружении соответствующих запросов.

### Доступные Skills

**screening** - Skill для скрининга торговых инструментов
- Автоматически применяется при запросах на скрининг акций, криптовалют или форекс
- Применяет критерии методологии Герчика (объем, волатильность, тренд, корреляция)
- Следует "Фильтру чёткого сетапа" - отбирает только инструменты с "супер понятной картинкой" (очевидный сетап, чёткие уровни, однозначный тренд, ясный вход)
- Подробнее см. [USAGE.md](USAGE.md#использование-skills)
