...
Агент: [Автоматически применяет skill screening:
        ...
        - Применяет фильтр чёткого сетапа (отбирает только инструменты с "супер понятной картинкой")
...
4. **Применение фильтра чёткого сетапа**: Строго отклоняет инструменты, оставляя только те с "супер понятной картинкой" (очевидный сетап, чёткие уровни, однозначный тренд, ясный вход)
...
- Skill строго следует "Фильтру чёткого сетапа" - большинство инструментов будет отклонено
